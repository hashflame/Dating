...
public sealed class BlizkaExceptionHandler(ILogger<BlizkaExceptionHandler> logger) : IExceptionHandler
{
    ...
    private static (int StatusCode, string Code, string? Action, object? Details) Classify(Exception exception) => exception switch
    {
        ...
        NothingToUndoException e => (StatusCodes.Status409Conflict, e.ErrorCode, null, e.Details),
        UndoLimitExceededException e => (StatusCodes.Status422UnprocessableEntity, e.ErrorCode, null, e.Details),
        ...
        ContactUnlockUnavailableException e => (StatusCodes.Status422UnprocessableEntity, e.ErrorCode, null, e.Details),
        ...
        NotificationsSeenConflictException e => (StatusCodes.Status409Conflict, e.ErrorCode, "RETRY", e.Details),
        IdeaNotFoundException e => (StatusCodes.Status404NotFound, e.ErrorCode, null, e.Details),
