...
internal static class DateIdeaCatalog
{
    ...
    [
        new(DatePreferenceCode.ActiveOutdoors, "Прогулка в парке",
            "Неспешная прогулка по одному из парков {0} с кофе навынос.", 10m, "1-2 часа",
            "Погода отличная — может, прогуляемся по парку в {0}? ☕"),
        new(DatePreferenceCode.ActiveOutdoors, "Велопрогулка",
            "Аренда велосипедов и небольшой маршрут по {0}.", 20m, "2 часа",
            "Как насчёт покататься на велосипедах по {0}?"),
        ...
        new(DatePreferenceCode.CalmHangout, "Вечер в чайной",
            "Разговор за чайной церемонией в одной из чайных {0}.", 20m, "1.5 часа",
        ...
        new(DatePreferenceCode.QuizzesBoardGames, "Квиз-вечер",
            "Командный квиз-вечер в одном из баров {0}.", 15m, "2-3 часа",
        ...
        new(null, "Прогулка по центру",
            "Прогулка по центру {0} с остановкой на кофе.", 10m, "1-2 часа",
            "Погуляем по центру {0}?"),
        new(null, "Кофе и разговоры",
            "Встреча в кофейне {0} — просто поговорить и узнать друг друга лучше.", 15m, "1 час",
