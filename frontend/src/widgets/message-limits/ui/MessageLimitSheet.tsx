 ...
 * молча нельзя — человек должен увидеть цену и согласиться. У суперсообщения
 * платят за отправку, а не за переход: в Telegram оно не ведёт.
 *
      ...
      >
        ...
        {charge.affordable ? (
          <>
            ...
            >
              {t(isSuper ? 'messages.limit.superPay' : 'messages.limit.pay', {
                cost: charge.cost,
              })}
            </Button>
          </>
